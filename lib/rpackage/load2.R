...
source(sprintf('%s/lib/rpackage/util.r',srcdir))
source(sprintf('%s/lib/rpackage/util.load.r',srcdir))
source(sprintf('%s/lib/rpackage/general-utilities.r',srcdir))
source(sprintf('%s/lib/rpackage/plink.r',srcdir))
source(sprintf('%s/lib/rpackage/MX.dataset.functions.r',srcdir))
